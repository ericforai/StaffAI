...
import { Building2, ClipboardList, BrainCircuit, BookOpenText, Clipboard, Store, BarChart3, ShieldCheck, Library, Users } from 'lucide-react';
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/elite', label: '精英克隆', icon: Users },
