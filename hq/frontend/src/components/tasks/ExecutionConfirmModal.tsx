...
export function ExecutionConfirmModal({
  ...
  return (
    ...
    >
      <div
        className="mx-4 max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="text-center">
          ...
          <h3 id="execution-confirm-title" className="text-lg font-bold text-slate-900">
            任务创建成功！
          </h3>
