...
/**
 * CodexRuntimeAdapter provides execution capabilities for the OpenAI Codex CLI.
 * Supports single, serial, and parallel execution modes.
 * Does not support advanced_discussion mode by default.
 */
export class CodexRuntimeAdapter implements RuntimeAdapter {
  readonly name = 'local_codex_cli';
  ...
  /**
   * Execute a single task context through Codex runtime.
   */
   ...
   * In production, this would delegate to the Codex CLI.
